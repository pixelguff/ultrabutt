...
def metafetch(bot, trigger):
    ...
    if len(arg_list) < 3:
        ...
        if platform not in platforms:
            bot.say(
                "Because you didn't pick a valid platform, I'm defaulting to 'xbone' to mock you.")
            platform = "xbone"
        ...
        try:
            webpage = opener.open(
                "http://www.metacritic.com/game/" + platform + "/" + gamestring)
            ...
            if len(result) != 0:
                ...
                bot.reply(
                    "I couldn't find it. Either it's not on Metacritic, or you typed the name wrong with your stupid chimp fingers.")
